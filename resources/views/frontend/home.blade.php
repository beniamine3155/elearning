...
<!-- Banner Starts Here -->
<section class="main-banner" style="background-image: url(frontend/dist/images/banner/banner.jpg);">
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-5 order-1 order-lg-0">
                <div class="main-banner-end">
                    <img src="frontend/dist/images/banner/banner-image-01.png" alt="image"
...
<section class="section browse-categories">
                ...
                <div class="browse-categories-item default-item-one mb-2">
                    <div class="browse-categories-item-icon">
                        <div class="categories-one default-categories">
                            <img src="uploads/courseCategories/{{$cat->category_image}}"
    ...
    <div class="browse-categories-shape">
        <img src="frontend/dist/images/shape/dots/dots-img-11.png" alt="shape"
            class="img-fluid shape-01" />
        <img src="frontend/dist/images/shape/line01.png" alt="shape" class="img-fluid shape-02" />
    </div>
</section>
...
<section class="section section--bg-offwhite-three featured-popular-courses main-popular-course">
                        ...
                        <div class="col-xl-4 col-md-6">
                            <div class="contentCard contentCard--course">
                                <div class="contentCard-top">
                                    <a href="#"><img src="uploads/courses/{{$pc->image}}" alt="images"
                                            class="img-fluid" /></a>
                                </div>
                                <div class="contentCard-bottom">
                                    ...
                                    <div class="contentCard-info d-flex align-items-center justify-content-between">
                                        <a href="{{route('instructorProfile', encryptor('encrypt', $pc->instructor?->id))}}"
                                            ...
                                            <img src="uploads/users/{{$pc?->instructor->image}}"
                                    ...
                                    <div class="contentCard-more">
                                        <div class="d-flex align-items-center">
                                            <div class="icon">
                                                <img src="frontend/dist/images/icon/star.png"
                                                    alt="star" />
                                            </div>
                                            <span>4.5</span>
                                        </div>
                                        <div class="eye d-flex align-items-center">
                                            <div class="icon">
                                                <img src="frontend/dist/images/icon/eye.png"
                                                    alt="eye" />
                                            </div>
                                            <span>24,517</span>
                                        </div>
                                        <div class="book d-flex align-items-center">
                                            <div class="icon">
                                                <img src="frontend/dist/images/icon/book.png"
                                                    alt="location" />
                                            </div>
                                        ...
                                        <div class="clock d-flex align-items-center">
                                            <div class="icon">
                                                <img src="frontend/dist/images/icon/Clock.png"
                                                    alt="clock" />
                                            </div>
                ...
                <div class="tab-pane fade" id="pills-design" role="tabpanel" aria-labelledby="pills-design-tab">
                    <div class="row">
                        ...
                        <div class="col-xl-4 col-md-6">
                            <div class="contentCard contentCard--course">
                                <div class="contentCard-top">
                                    <a href="#"><img src="uploads/courses/.{{$dc->image}}" alt="images" class="img-fluid" /></a>
                                </div>
                                <div class="contentCard-bottom">
                                    <h5>
                                    ...
                                    <div class="contentCard-info d-flex align-items-center justify-content-between">
                                        <a href="{{route('instructorProfile', encryptor('encrypt', $dc->instructor?->id))}}"
                                            class="contentCard-user d-flex align-items-center">
                                            <img src="uploads/users/{{$dc?->instructor->image}}" alt="client-image"
                                    ...
                                    <div class="contentCard-more">
                                        <div class="d-flex align-items-center">
                                            <div class="icon">
                                                <img src="frontend/dist/images/icon/star.png" alt="star" />
                                            </div>
                                            <span>4.5</span>
                                        </div>
                                        <div class="eye d-flex align-items-center">
                                            <div class="icon">
                                                <img src="frontend/dist/images/icon/eye.png" alt="eye" />
                                            </div>
                                            <span>24,517</span>
                                        </div>
                                        <div class="book d-flex align-items-center">
                                            <div class="icon">
                                                <img src="frontend/dist/images/icon/book.png" alt="location" />
                                            </div>
                                            <span>{{$dc->lesson?$dc->lesson:0}} Lesson</span>
                                        </div>
                                        <div class="clock d-flex align-items-center">
                                            <div class="icon">
                                                <img src="frontend/dist/images/icon/Clock.png" alt="clock" />
                                            </div>
                ...
                <div class="tab-pane fade" id="pills-dev" role="tabpanel" aria-labelledby="pills-dev-tab">
                    <div class="row">
                        ...
                        <div class="col-xl-4 col-md-6">
                            <div class="contentCard contentCard--course">
                                <div class="contentCard-top">
                                    <a href="#"><img src="uploads/courses/{{$dv->image}}" alt="images"
                                            class="img-fluid" /></a>
                                </div>
                                <div class="contentCard-bottom">
                                    <h5>
                                    ...
                                    <div class="contentCard-info d-flex align-items-center justify-content-between">
                                        <a href="{{route('instructorProfile', encryptor('encrypt', $dv->instructor?->id))}}"
                                            class="contentCard-user d-flex align-items-center">
                                            <img src="uploads/users/{{$dv?->instructor->image}}" alt="client-image"
                                                class="rounded-circle" height="34" width="34" />
                ...
                <div class="tab-pane fade" id="pills-bus" role="tabpanel" aria-labelledby="pills-bus-tab">
                    <div class="row">
                        ...
                        <div class="col-xl-4 col-md-6">
                            <div class="contentCard contentCard--course">
                                <div class="contentCard-top">
                                    <a href="#"><img src="uploads/courses/{{$bc->image}}" alt="images"
                                            class="img-fluid" /></a>
                                </div>
                                <div class="contentCard-bottom">
                                    <h5>
                                    ...
                                    <div class="contentCard-info d-flex align-items-center justify-content-between">
                                        <a href="{{route('instructorProfile', encryptor('encrypt', $bc->instructor?->id))}}"
                                            class="contentCard-user d-flex align-items-center">
                                            <img src="uploads/users/{{$bc?->instructor->image}}" alt="client-image"
                                                class="rounded-circle" height="34" width="34" />
                ...
                <div class="tab-pane fade" id="pills-its" role="tabpanel" aria-labelledby="pills-its-tab">
                    <div class="row">
                        ...
                        <div class="col-xl-4 col-md-6">
                            <div class="contentCard contentCard--course">
                                <div class="contentCard-top">
                                    <a href="#"><img src="uploads/courses/{{$ic->image}}" alt="images"
                                            class="img-fluid" /></a>
                                </div>
                                <div class="contentCard-bottom">
                                    <h5>
                                    ...
                                    <div class="contentCard-info d-flex align-items-center justify-content-between">
                                        <a href="{{route('instructorProfile', encryptor('encrypt', $ic->instructor?->id))}}"
                                            class="contentCard-user d-flex align-items-center">
                                            <img src="uploads/users/{{$ic?->instructor->image}}" alt="client-image"
                                                class="rounded-circle" height="34" width="34" />
    ...
    <div class="featured-popular-courses-shape">
        <img src="frontend/dist/images/shape/dots/dots-img-12.png" alt="Shape"
            class="img-fluid dot-06" />
        <img src="frontend/dist/images/shape/triangel.png" alt="Shape" class="img-fluid dot-07" />
    </div>
</section>
...
<section class="section learning-rules">
        ...
        <div class="row align-items-center">
            ...
            <div class="col-lg-6 order-1 order-lg-0">
                <div class="learning-rules-ends">
                    <img src="frontend/dist/images/hero/hero-img-01.jpg" alt="img"
                        class="img-fluid rounded"/>
                    <div class="learning-rules-ends-circle">
                        <img src="frontend/dist/images/shape/l03.png" alt="shape"
                            class="img-fluid" />
                    </div>
                    <div class="earning-rules-ends-shape">
                        <img src="frontend/dist/images/shape/l04.png" alt="shape"
    ...
    <div class="learning-rules-shape">
        <img src="frontend/dist/images/shape/dots/dots-img-16.png" alt="shape"
            class="img-fluid shape-01" />
        <img src="frontend/dist/images/shape/l02.png" alt="shape" class="img-fluid shape-02" />
    </div>
</section>
...
<section class="section about-services section section--bg-offgradient">
        ...
        <div class="testimonial testimonial--one testimonial__slider--one">
                ...
                <div class="testimonial__user-wrapper d-flex justify-content-between">
                    <div class="testimonial__user d-flex align-items-center">
                        <div class="testimonial__user-img">
                            <img src="frontend/dist/images/avatar/avatar-img-01.png" alt="Client" />
                        </div>
            ...
            <div class="testimonial__item">
                ...
                <div class="testimonial__user-wrapper d-flex justify-content-between">
                    <div class="testimonial__user d-flex align-items-center">
                        <div class="testimonial__user-img">
                            <img src="frontend/dist/images/avatar/avatar-img-02.png" alt="Client" />
                        </div>
                        <div class="testimonial__user-info">
                            <h6>Dev Zakir</h6>
                            <span class="font-para--md">UI/UX Student</span>
            ...
            <div class="testimonial__item">
                ...
                <div class="testimonial__user-wrapper d-flex justify-content-between">
                    <div class="testimonial__user d-flex align-items-center">
                        <div class="testimonial__user-img">
                            <img src="frontend/dist/images/avatar/avatar-img-03.png" alt="Client" />
                        </div>
                        <div class="testimonial__user-info">
                            <h6>Dev Kate</h6>
                            <span class="font-para--md">UI/UX Student</span>
    ...
    <div class="about-services-shape">
        <img src="frontend/dist/images/shape/line02.png" alt="shape"
            class="img-fluid img-shape-01" />
        <img src="frontend/dist/images/shape/dots/dots-img-13.png" alt="shape"
            class="img-fluid img-shape-02" />
        <img src="frontend/dist/images/shape/l02.png" alt="shape" class="img-fluid img-shape-03" />
    </div>
            ...
            <div class="col-lg-12">
                <div class="brand-area">
                    <div class="brand-area-image">
                        <img src="frontend/dist/images/versity/1.png" alt="Brand"
                            class="img-fluid" />
                    </div>
                    <div class="brand-area-image">
                        <img src="frontend/dist/images/versity/2.png" alt="Brand"
                            class="img-fluid" />
                    </div>
                    <div class="brand-area-image">
                        <img src="frontend/dist/images/versity/3.png" alt="Brand"
                            class="img-fluid" />
                    </div>
                    <div class="brand-area-image">
                        <img src="frontend/dist/images/versity/4.png" alt="Brand"
                            class="img-fluid" />
                    </div>
                    <div class="brand-area-image">
                        <img src="frontend/dist/images/versity/2.png" alt="Brand"
                    ...
                    <div class="brand-area-image">
                        <img src="frontend/dist/images/versity/5.png')}}" alt="Brand"
                            class="img-fluid" />
                    </div>
                </div>
            </div>
...
<section class="section best-instructor-featured overflow-hidden main-instructor-featured">
                    ...
                    <div class="ourinstructor-active">
                        ...
                        <div class="mentor">
                            <div class="mentor__img">
                                <img src="uploads/users/{{$i->image}}" alt="Mentor image" />
    ...
    <div class="main-instructor-featured-shape">
        <img src="frontend/dist/images/shape/dots/dots-img-14.png" alt="shape"
            class="img-fluid shape01" />
        <img src="frontend/dist/images/shape/triangel2.png" alt="shape" class="img-fluid shape02" />
    </div>
</section>
...
<section class="section section--bg-offwhite-three latest-events-featured main-events-featured">
            ...
            <div class="col-12 position-relative px-0 mx-0">
                <div class="eventsSlider">
                    ...
                    <div class="contentCard contentCard--event contentCard--space">
                        <div class="contentCard-top">
                            <a href="#"><img src="uploads/courses/{{$c->image}}" alt="images"
                                    class="img-fluid" /></a>
                        </div>
                        <div class="contentCard-bottom">
                            <h5>
                            ...
                            <div class="contentCard-more">
                                <div class="d-flex align-items-center">
                                    <div class="icon">
                                        <img src="frontend/dist/images/icon/location.png"
                                            alt="location" />
                                    </div>
                                ...
                                <div class="d-flex align-items-center">
                                    <div class="icon">
                                        <img src="frontend/dist/images/icon/calendar.png"
                                            alt="calendar" />
                                    </div>
    ...
    <div class="main-events-featured-shape">
        <img src="frontend/dist/images/shape/triangel3.png" alt="shape" class="img-fluid shape01" />
    </div>
</section>
...
<section class="section main-become-instructor">
        ...
        <div class="row">
            <div class="col-lg-6">
                <div class="main-become-instructor-item me-12">
                    <div class="main-image">
                        <img src="frontend/dist/images/event/image01.png" alt="image"
                            class="img-fluid" />
                    </div>
                    <div class="main-text">
            ...
            <div class="col-lg-6">
                <div class="main-become-instructor-item ms-12 mb-0">
                    <div class="main-image">
                        <img src="frontend/dist/images/event/image02.png" alt="image"
                            class="img-fluid" />
                    </div>
                    <div class="main-text">
    ...
    <div class="main-become-instructor-shape">
        <img src="frontend/dist/images/shape/line03.png" alt="shape" class="img-fluid" />
    </div>
</section>
