...
@push('styles')
<link rel="stylesheet" href="frontend/src/scss/vendors/plugin/css/jquery-ui.css" />
@endpush
                        ...
                        <div class="contentCard contentCard--course">
                            <div class="contentCard-top">
                                <a href="{{route('courseDetails', encryptor('encrypt', $c->id))}}"><img
                                        src="uploads/courses/{{$c->image}}" alt="images"
                                        class="img-fluid" /></a>
                            </div>
                            <div class="contentCard-bottom">
                                ...
                                <div class="contentCard-info d-flex align-items-center justify-content-between">
                                    <a href="{{route('instructorProfile', encryptor('encrypt', $c->instructor?->id))}}"
                                        ...
                                        <img src="uploads/users/{{$c->instructor?->image}}"
...
@push('scripts')
<script src="frontend/src/scss/vendors/plugin/js/price_range_script.js"></script>
<script src="frontend/src/scss/vendors/plugin/js/jquery-ui.min.js"></script>
<script>
