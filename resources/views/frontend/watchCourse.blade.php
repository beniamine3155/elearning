...
<head>
    ...
    <link rel="stylesheet" href="frontend/src/scss/vendors/plugin/css/video-js.css" />
    ...
    <link rel="icon" type="image/png" href="frontend/dist/images/favicon/favicon.png" />
    <link rel="stylesheet" href="frontend/fontawesome-free-5.15.4-web/css/all.min.css">
    <style>
        .vjs-poster {
            width: 100%;
...
<body style="background-color: #ebebf2;">
            ...
            <div class="coursedescription-header">
                <div class="coursedescription-header-start">
                    <a class="logo-image" href="{{route('home')}}">
                        <img src="frontend/dist/images/logo/logo.png" alt="Logo" />
                    </a>
                ...
                <div class="course-description-start">
                    <div class="video-area">
                        <video controls id="myvideo" class="video-js w-100"
                            poster="frontend/dist/images/courses/vthumb.jpg">
                                    ...
                                    <div class="students-feedback pt-0 ps-0 pe-0 pb-0 mb-0">
                                        ...
                                        <div class="students-feedback-item">
                                            <div class="feedback-rating">
                                                <div class="feedback-rating-start">
                                                    <div class="image">
                                                        <img src="frontend/dist/images/ellipse/user.jpg" alt="Image" />
                                                    </div>
                                                    <div class="text">
                                        ...
                                        <div class="students-feedback-item">
                                            <div class="feedback-rating">
                                                <div class="feedback-rating-start">
                                                    <div class="image">
                                                        <img src="frontend/dist/images/ellipse/1.png" alt="Image" />
                                                    </div>
                                                    <div class="text">
                                                        <h6><a href="#">Harry Pinsky</a></h6>
                                                        <p>2 hour ago</p>
                                        ...
                                        <div class="students-feedback-item">
                                            <div class="feedback-rating">
                                                <div class="feedback-rating-start">
                                                    <div class="image">
                                                        <img src="frontend/dist/images/ellipse/2.png" alt="Image" />
                                                    </div>
                                                    <div class="text">
                                        ...
                                        <div class="students-feedback-item border-0">
                                            <div class="feedback-rating">
                                                <div class="feedback-rating-start">
                                                    <div class="image">
                                                        <img src="frontend/dist/images/ellipse/3.png" alt="Image" />
                                                    </div>
                                                    <div class="text">
                                                        <h6><a href="#">Watcraz Eggsy</a></h6>
                                                        <p>1 day ago</p>
    ...
    <script src="frontend/src/js/jquery.min.js"></script>
    <script src="frontend/src/js/bootstrap.bundle.min.js"></script>
    <script src="frontend/src/scss/vendors/plugin/js/video.min.js"></script>
    <script src="frontend/src/scss/vendors/plugin/js/isotope.pkgd.min.js"></script>
    <script src="frontend/src/scss/vendors/plugin/js/jquery.magnific-popup.min.js"></script>
    <script src="frontend/src/scss/vendors/plugin/js/slick.min.js"></script>
    <script src="frontend/src/scss/vendors/plugin/js/jquery.nice-select.min.js"></script>
    ...
    <script>
        ...
        function show_video(e){
            let link="uploads/courses/contents/"+e
